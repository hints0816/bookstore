...
<div class="main">
	<h2>管理班级信息</h2>
		<div class="antzoen">
			...
			销售员工号：<input type="text" name="salesid" value="${returncname}" />
    ...
    <table>  
        <tr>  
        	...
        	<c:set var="salespersonDao" value="${SalespersonDao()}"></c:set>
	        <c:forEach var="newinfo" items="${salespersonDao.getSalesperson()}">
        <tr>  
            ...
            <td>${newinfo.getAccountname()}</td>  
             ...
             <td>  
               <a href="delSales_do.jsp?id=${newinfo.getSalespersonid()}" id="delete" class="button-select blue">删除</a>
            </td>  
        </tr>  
         </c:forEach>
    </table>  
