...
<div class="content">
	...
	<h2>添加图书信息</h2>
		<div class="antzoen">
			<form action="addBook_do.jsp" method="post">
			<table>
				<tr>
					<td>图书编号：</td>
					<td><input type="text" name="bookid" value="${c1.getBookid()}"/><span class="error">${errors.get("bookid")}</span></td>
				</tr>
				<tr>
					<td>图书名字：</td>
					<td><input type="text" name="bookname" value="${c1.getBookname()}"/><span class="error">${errors.get("bookname")}</span></td>
				</tr>
				<tr>
					<td>作者：</td>
					<td><input type="text" name="author" value="${c1.getAuthor()}"/><span class="error">${errors.get("author")}</span></td>
				</tr>
				<tr>
					<td>单价：</td>
					<td><input type="text" name="price" value="${c1.getPrice()}"/><span class="error">${errors.get("price")}</span></td>
				</tr>
				<tr>
					<td>类别：</td>
					<td><input type="text" name="category" value="${c1.getCategory()}"/><span class="error">${errors.get("category")}</span></td>
				</tr>
				<tr>
					<td>出版社：</td>
					<td><input type="text" name="publish" value="${c1.getPublish()}"/><span class="error">${errors.get("publish")}</span></td>
				</tr>
				<tr>
					<td>出版日期：</td>
					<td><input type="date" name="publish_date" value="${c1.getPublish_date()}"/><span class="error">${errors.get("publish_date")}</span></td>
				</tr>
				<tr>
					<td>库存：</td>
					<td><input type="text" name="bookcount" value="${c1.getBookcount()}"/><span class="error">${errors.get("bookcount")}</span></td>
				</tr>
			</table>
			<div class="button">
