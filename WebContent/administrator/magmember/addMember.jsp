...
<div class="content">
	...
	<h2>添加会员信息</h2>
		<div class="antzoen">
			<form action="addMember_do.jsp" method="post">
			<table>
				<tr>
					<td>会员编号：</td>
					<td><input type="text" name="memid" value="${c1.getMemid()}"/><span class="error">${errors.get("memid")}${existmember}</span></td>
				</tr>
				<tr>
					<td>会员名字：</td>
					<td><input type="text" name="memname" value="${c1.getMemname()}"/><span class="error">${errors.get("memname")}</span></td>
				</tr>
				<tr>
					<td>电话号码：</td>
					<td><input type="text" name="memnumber" value="${c1.getMemnumber()}"/><span class="error">${errors.get("memnumber")}</span></td>
				</tr>
				<tr>
					<td>入会日期：</td>
					<td><input type="date" name="memdate" value="${c1.getMemdate()}"/><span class="error">${errors.get("memdate")}</span></td>
				</tr>
			</table>
			<div class="button">
